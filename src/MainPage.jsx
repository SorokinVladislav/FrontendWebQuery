...
let MainPage = ({currentPage, onPageChanged, totalUsersCount, pageSize, users, jobs, ...props}) => {
    return (<div>
        <audio className="audio-for-speech" src=""></audio>
        <div className="translate-tooltip-mtz hidden">
            <div className="header">
                <div className="header-controls"><span className="sound-translate"></span> <span
                    className="settings"></span></div>
                <div className="translate-icons"></div>
            </div>
        ...
        <span className="translate-button-mtz hidden"></span>
...
{/*        <script defer="">
    ...
    {/*    <script type="text/javascript"> (function (m, e, t, r, i, k, a){m[i] = m[i] || function () {
        ...
        ; ym(39705265, "init", {clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true})
        ; </script>*/}
        <noscript>
            <div><img src="https://mc.yandex.ru/watch/39705265" alt=""/></div>
        </noscript>
        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <main role="main" className="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    ...
                    <canvas className="my-4 chartjs-render-monitor" id="myChart" width="1161" height="490"
                           ></canvas>
